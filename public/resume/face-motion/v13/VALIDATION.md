...
| left | `[69, 96, 1196, 1254]` | 730,313 | 11,340 | 813,816 |
| center | `[69, 99, 1196, 1254]` | 724,528 | 5,973 | 760,630 |
| right | `[68, 98, 1194, 1254]` | 724,103 | 10,353 | 809,628 |
...
Visual inspection confirmed crisp lenses and metal rims without doubled or vertically smeared eyewear, diagonal-reference hair continuity, visible authored up/down movement, and the generated white crew-neck plus charcoal open overshirt in all nine endpoints. The rebuilt `right` to `bottom-right` transition remains a visible lossless `1254×1254` frame with alpha bounds `[79, 117, 1188, 1254]`.
