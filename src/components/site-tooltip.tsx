  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Positioner
        ...
        align={align}
        alignOffset={alignOffset}
        className="[transition-property:top,left,right,bottom,transform] duration-240 ease-(--ease-settle) motion-reduce:transition-none isolate z-50"
        side={side}
        sideOffset={sideOffset}
        collisionPadding={16}
        collisionAvoidance={{
