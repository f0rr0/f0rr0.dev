...
import leadImage from "./opengraph-image.jpg";
...
<figure>
  <Image
    src={leadImage}
    priority
    alt="Cut-paper portraits of Sid in several head poses, with the central face turned toward a saffron mouse cursor."
  />
</figure>
