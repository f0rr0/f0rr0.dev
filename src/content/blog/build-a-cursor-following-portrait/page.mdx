...
Retargeting matters more than it first appears. Reversing halfway through a turn can make the portrait jitter when the cursor hovers near a direction boundary. The controller finishes the current turn, then follows the latest requested direction. The same three intermediate images work in both directions.
