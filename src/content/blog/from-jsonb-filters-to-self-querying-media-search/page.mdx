...
![An editor compares a forearm illustration with the matching picture in a lesson, while setting aside a lower-leg image.](./choosing-a-teaching-image.webp)

  <figcaption>An image of the right subject can still be the wrong choice for a lesson.</figcaption>
</figure>
