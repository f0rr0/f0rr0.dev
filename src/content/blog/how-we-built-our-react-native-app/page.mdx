...
![Housing search on iOS and Android](./hero.png)

  <figcaption><a href="http://housing.com/apps">housing.com/apps</a></figcaption>
</figure>
...
![Styleguide (Consistent across Android and iOS)](./styleguide.png)

  <figcaption>Styleguide (Consistent across Android and iOS)</figcaption>
</figure>
...
still deliberating on best practices and the _right way_ to do certain things.
