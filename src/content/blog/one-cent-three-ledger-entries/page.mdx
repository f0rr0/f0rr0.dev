...
![Two couriers bring unmarked job slips to a shared workshop till holding a lone paper token.](./competing-requests.webp)
...
![A workshop clerk returns a token after a failed print job while receipts marked Paid and Returned remain together in the ledger.](./charge-and-refund.webp)
...
![A receipt enters a paper ledger whose gears and belt drive a protected, unnumbered balance gauge.](./ledger-projection.webp)
...
![A purchase receipt marked Recorded remains safely filed while its acknowledgement envelope tears in transit, leaving the recipient with no reply.](./lost-acknowledgement.webp)
