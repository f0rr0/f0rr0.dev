...
![The archived YUPPI.ES homepage: pink masthead, cyan links, crossed-out former cities, Berlin and Lufthansa in the introduction, and a loading message for lifelogging feeds.](./archived-homepage.webp)
